...
class ThirdFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.nextthird.setOnClickListener {
            findNavController().navigate(R.id.action_thirdFragment_to_FirstFragment)
        }

        val imageViews = arrayOfNulls<ImageView>(9) // Replace 4 with the number of ImageViews you want in your array
        ...
        imageViews[8] = binding.imageView10
